...
SELECT album.Title, artist.Name AS NombreArtista, count(track.TrackId) as NoPistas
FROM album
JOIN artist on album.ArtistId = artist.ArtistId
...
SELECT Genre.Name, COUNT(Track.TrackId) AS Cantidad_Pistas
FROM Genre
